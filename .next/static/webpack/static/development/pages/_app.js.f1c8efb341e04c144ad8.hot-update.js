...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  switch (action.type) {
    ...
    case _ProductTypes__WEBPACK_IMPORTED_MODULE_8__["GET_PRODUCT_GRADES_SUCCESS"]:
      ...
      var productGrade = payload.gradesData.data.fields.find(function (element) {
        return element.id === payload.gradeId;
      });
      var accessoriesIdList = {};

      var populateAccessoriesIds = function populateAccessoriesIds(payload) {
        _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_6___default()(payload.accessoriesData.data.fields).map(function (value) {
    ...
    case _ProductTypes__WEBPACK_IMPORTED_MODULE_8__["GET_PRODUCT_GRADE_DATA_SUCCESS"]:
      ...
      var populateAccessoriesIds = function populateAccessoriesIds(action) {
        _babel_runtime_corejs2_core_js_object_values__WEBPACK_IMPORTED_MODULE_6___default()(action.payload.accessoriesData.data.fields).map(function (value) {
          value.map(function (item) {
            accessoriesIdList[item.id] = false;
          });
        });
...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(payload) {
    var gradesData, gradeId, exteriorData, interiorData, accessoriesData, data;
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Api__WEBPACK_IMPORTED_MODULE_5__["default"].get("/products/specificGrades/".concat(payload.payload.modelId));

          case 2:
            gradesData = _context2.sent;
            gradeId = null;
            !!payload.payload.gradeId ? gradeId = payload.payload.gradeId : gradeId = gradesData.data.fields[0].id;
            _context2.next = 7;
            return Api__WEBPACK_IMPORTED_MODULE_5__["default"].get("/products/specificVariantExterior/".concat(gradeId));

          case 7:
            exteriorData = _context2.sent;
            _context2.next = 10;
            return Api__WEBPACK_IMPORTED_MODULE_5__["default"].get("/products/specificVariantInterior/".concat(gradeId));

          case 10:
            interiorData = _context2.sent;
            _context2.next = 13;
            return Api__WEBPACK_IMPORTED_MODULE_5__["default"].get("/products/specificGradeProductOption/".concat(gradeId));

          case 13:
            accessoriesData = _context2.sent;
            data = {
              gradeId: gradeId,
...
//# sourceMappingURL=_app.js.f1c8efb341e04c144ad8.hot-update.js.map