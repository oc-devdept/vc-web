...
class Accessories extends Component {
  ...
  componentDidMount() {
    ...
    Object.keys(this.props.ProductState.ProductAccessories.data.fields).map(
      (item, id) => {
        list[id] = "0";
      }
    );
                                  ...
                                  <div className="col-9">
                                    <div className="mr-4">
                                      ...
                                      <p className="text-justify">
                                        Maecenas tristique justo odio, gravida
                                        vehicula tellus condimentum quis.
                                        Integer rhoncus tortor et arcu auctor
                                        fermentum. Suspendisse feugiat molestie
                                        pellentesque. Donec sed eleifend libero.
                                        Duis egestas porttitor dui sed
                                        fringilla. Duis massa turpis, semper nec
                                        sollicitudin a, commodo eu tortor. Ut
                                        quis nunc ipsum.
                                      </p>
                                    </div>
                                  </div>
