...
class BestSeller extends Component {
    constructor(props) {
      ...
      return (<section className="best-sellers-area">
                              ...
                              <div className="single-product-box">
                                  <div className="product-image">
                                      ...
                                      <Link href={`/product/grade/${grade.id}`}>
                                          <a>
                                            <img style={modelImage} src={gradeImg.url} key={idx} />
                                          </a>
                                      </Link>))}
                                  </div>
                                  ...
                                  <div className="product-content">
                                      ...
                                      <div className="product-price">
                                          <span className="new-price">S$ {grade.selling_Price.toLocaleString(undefined, {maximumFractionDigits:2})}</span>
                                      </div>
                                      ...
                                      {grade.power &&                                   
                                        <dl>
                                          ...
                                          <dd>{grade.power.value}</dd> <dd>{grade.power.detailCategory.unit}</dd>
                                        </dl>
                                      ...
                                      {grade.engine &&
                                        <dl>
                                          ...
                                          <dd>{grade.engine.value}</dd> <dd>{grade.engine.detailCategory.unit}</dd>
                                      ...
                                      {grade.fuel &&
                                        <dl>
                                          ...
                                          <dd>{grade.fuel.value}</dd> <dd>{grade.fuel.detailCategory.unit}</dd>
                                        </dl>
                                      }
                                      </div>  
