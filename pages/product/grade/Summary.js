      ...
      <div className="row">
        ...
        <div className="col-lg-6">
          <div className="py-3 px-0">
            <p style={{color:"#F29D30", fontWeight:600}}>CAR LOAN CALCULATOR</p>
          </div>
          <div style={{minHeight:300, border:"1px solid #F29D30", marginBottom:"1rem"}}>
            <LoanCalculator 
              productTotal={props.ProductState.ProductTotal}
              updateLoanCalculator={props.updateLoanCalculator}
            />
          </div>
          <div style={{minHeight:100, backgroundColor:"#4B6674", marginBottom:"1rem"}}>
            <div className="p-3">
              <p style={{color:"#F29D30", textAlign:"center", fontWeight:600, margin:0}}>OVERALL SUMMARY</p>
              { overallSummary.map(( item, key ) => (
                <div key={ key } className="d-flex justify-content-between">
                  <p style={{color:"#ffffff", margin:0, fontWeight:600}}>{item.text}</p>
                  {!!item.price 
                    ? <p style={{color:"#ffffff"}}>${formatPrice(parseFloat(item.price).toFixed(2))}</p>
          ...
          <div className="d-flex justify-content-between">
            <div className="d-flex">
              ...
              >
                ...
                <a href='#'>
                  <p style={{fontSize:12, color:"#4b6674", textAlign:"center"}}>BOOK TEST DRIVE</p>
                </a>
              </button>
            </div>
            <div className="d-flex">
