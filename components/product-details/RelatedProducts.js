                                    ...
                                    <div className="col-lg-12 col-md-12" key={idx}>
                                        <div className="single-product-box">
                                            ...
                                            <div className="product-content">
                                                ...
                                                <dl className="product-desc">
                                                    <dt className="product-desc-terms">Engine Capacity:</dt>
                                                    <dd className="product-desc-cont">{data.engineCap}</dd>
                                                    <dt className="product-desc-terms">Power:</dt>
                                                    <dd className="product-desc-cont">{data.power}</dd>
                                                    <dt className="product-desc-terms">Fuel Consumption:</dt>
                                                    <dd className="product-desc-cont">{data.fuelConspt}</dd>
                                                </dl>                        
